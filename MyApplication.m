...
- (void) performFindPanelAction: (id) sender
{
	...
	switch ([sender tag])
	{
        ...
        {
            break; // Variable 'selection' is uninitialized. Skip code below that uses it. JMN 07-03-2018
        }
		
		// Load up on find pasteboard.
            findPasteboard = [NSPasteboard pasteboardWithName: NSPasteboardNameFind];
